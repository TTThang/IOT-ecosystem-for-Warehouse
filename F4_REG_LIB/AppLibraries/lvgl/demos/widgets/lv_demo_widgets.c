...
static void profile_create(lv_obj_t * parent)
{
    ...
    lv_label_set_text(email_label, "aaanh01@gmail.com");
    ...
    lv_label_set_text(call_label, "+84 986382835");
