...
#if LV_TICK_CUSTOM
    #define LV_TICK_CUSTOM_INCLUDE "RCC_F4xx.h"         /*Header for the system time function*/
    #define LV_TICK_CUSTOM_SYS_TIME_EXPR gettick()    /*Expression evaluating to current system time in ms*/
