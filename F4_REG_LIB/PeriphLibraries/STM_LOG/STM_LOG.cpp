...
void STM_LOG_MEM(void){
	...
	STM_LOG(BCKGRN_BLACK, "STM32_LOG MEMORY USED", "heap_ram_used %lu, prog_ram_used %lu, stack_ram_used %lu.", mem.heap_ram_used, mem.prog_ram_used, mem.stack_ram_used);
	STM_LOG(BCKGRN_BLACK, "STM32_LOG MEMORY FREE", "total_free_ram %lu, free_ram %lu.", mem.total_free_ram, mem.free_ram);
}
