...
#define DATA_ETH_CONNECT        "ETH CONNECTED"
#define DATA_ETH_DISCONNECT     "ETH DISCONNECTED"
#define DATA_WIFI_CONNECT       "WIFI CONNECTED"
#define DATA_WIFI_DISCONNECT    "WIFI DISCONNECTED"
